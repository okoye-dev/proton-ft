...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn("h-16 [&_tr]:border-b", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 bg-subheader-lightblue px-4 text-left align-middle font-semibold text-primary [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]",
      className,
    )}
    {...props}
  />
