...
const ActivityReport: FC<IProps> = ({ reportData }) => {
  const active = reportData.timeActiveInPercentage ?? 0;
  const absent = reportData.timeAbsentInPercentage ?? 0;
  return (
    <div className="relative flex w-full flex-col justify-around rounded-3xl border border-border-subheader p-4 pt-14 text-primary lg:pt-[38px]">
